...
//     () =>
//       tasks.filter(
//         (task) => task.relatedTo?.type === "customer" && task.relatedTo?.id === customer.id,
//       ),
//     [tasks, customer.id],
//   )
...
//     customer.lastContactDate instanceof Date
...
//       {/* Significantly enlarged dialog with better responsive breakpoints */}
//       <DialogContent className="w-[98vw] sm:w-[95vw] md:w-[92vw] lg:w-[88vw] max-w-[1400px] h-[95vh] max-h-[95vh] overflow-hidden flex flex-col p-0">
//         {/* Fixed header */}
...
//             {/* Main Content - Customer Information + Activity */}
...
//                     <div>
//                       <div className="text-xs sm:text-sm font-medium text-muted-foreground mb-1">Full Name</div>
//                       <div className="text-sm sm:text-base font-medium">{customer.name || "—"}</div>
//                     </div>
//                     <div>
...
//                         <div className="text-xs sm:text-sm font-medium text-muted-foreground mb-1">Email</div>
//                         <div className="text-sm sm:text-base break-words">{customer.email || "—"}</div>
//                       </div>
//                     </div>
//                     <div className="flex items-start gap-3">
//                       <Phone className="h-4 w-4 sm:h-5 sm:w-5 text-muted-foreground mt-0.5 shrink-0" />
//                       <div className="min-w-0 flex-1">
//                         <div className="text-xs sm:text-sm font-medium text-muted-foreground mb-1">Phone</div>
//                         <div className="text-sm sm:text-base">{customer.phone || "—"}</div>
//                       </div>
//                     </div>
//                   </div>
...
//                         <div className="min-w-0 flex-1">
//                           <div className="text-xs sm:text-sm font-medium text-muted-foreground mb-1">WhatsApp</div>
//                           <div className="text-sm sm:text-base text-green-600">{customer.whatsappNumber}</div>
//                         </div>
//                       </div>
//                     </>
//                   )}
...
//                         Services
//                       </div>
//                       <div className="text-sm sm:text-base">{renderServices()}</div>
//                     </div>
//                   </div>
...
//                       <Separator />
//                       <div className="flex items-start gap-3">
//                         <Building className="h-4 w-4 sm:h-5 sm:w-5 text-muted-foreground mt-0.5 shrink-0" />
//                         <div className="min-w-0 flex-1">
//                           <div className="text-xs sm:text-sm font-medium text-muted-foreground mb-1">Company</div>
//                           <div className="text-sm sm:text-base">
//                             {customer.company || "—"}
//                             {(customer as any).industry ? ` • ${(customer as any).industry}` : ""}
//                           </div>
//                         </div>
//                       </div>
//                     </>
...
//                         <div className="min-w-0 flex-1">
//                           <div className="text-xs sm:text-sm font-medium text-muted-foreground mb-1">Address</div>
...
//                       <Separator />
//                       <div>
//                         <div className="text-xs sm:text-sm font-medium text-muted-foreground mb-2">Notes</div>
//                         <div className="text-sm sm:text-base bg-muted p-3 sm:p-4 rounded-md whitespace-pre-line">
//                           {customer.notes}
//                         </div>
//                       </div>
//                     </>
...
//                             <div className="text-sm sm:text-base font-medium truncate">{task.title}</div>
...
//             {/* Sidebar: metrics + related + actions */}
...
//                     <div className="min-w-0 flex-1">
//                       <div className="text-xs sm:text-sm font-medium text-muted-foreground">Customer Since</div>
//                       <div className="text-sm sm:text-base">{createdAtLabel}</div>
//                     </div>
//                   </div>
...
//                     <div className="min-w-0 flex-1">
//                       <div className="text-xs sm:text-sm font-medium text-muted-foreground">Last Contact</div>
//                       <div className="text-sm sm:text-base">{lastContactLabel}</div>
//                     </div>
//                   </div>
//                 </CardContent>
//               </Card>
...
//               <Card>
//                 <CardHeader>
//                   <CardTitle className="text-base sm:text-lg">Related Records</CardTitle>
//                 </CardHeader>
...
//                       <span className="text-sm sm:text-base">Deals</span>
//                     </div>
//                     <span className="text-sm sm:text-base font-semibold">{customerDeals.length}</span>
//                   </div>
...
//                     </div>
//                     <span className="text-sm sm:text-base font-semibold">{customerInvoices.length}</span>
//                   </div>
...
//                     </div>
//                     <span className="text-sm sm:text-base font-semibold">{customerTasks.length}</span>
//                   </div>
//                 </CardContent>
//               </Card>
...
//       inactive: "bg-gray-100 text-gray-800 hover:bg-gray-100 dark:bg-gray-800 dark:text-gray-400",
//       prospect: "bg-blue-100 text-blue-800 hover:bg-blue-100 dark:bg-blue-900/30 dark:text-blue-400",
//     }
//     return variants[status] || variants.active
//   }
...
//                         <div className="text-sm sm:text-base font-medium break-words">{customer.name || "—"}</div>
//                       </div>
//                       <div className="space-y-1">
...
//                             <div className="text-sm text-green-600">{customer.whatsappNumber}</div>
//                           </div>
//                         </div>
//                       </>
//                     )}
...
//                       <Calendar className="h-4 w-4 sm:h-5 sm:w-5 text-purple-600 shrink-0" />
//                       <div className="min-w-0 flex-1">
//                         <div className="text-xs font-medium text-muted-foreground">Last Contact</div>
...
//                       </div>
//                       <span className="text-xs sm:text-sm font-semibold">{customerDeals.length}</span>
//                     </div>
...
//                       </div>
//                       <span className="text-xs sm:text-sm font-semibold">{customerInvoices.length}</span>
//                     </div>
...
//                       </div>
//                       <span className="text-xs sm:text-sm font-semibold">{customerTasks.length}</span>
//                     </div>
//                   </CardContent>
//                 </Card>
...
//testing for lead page to convert to cusotmer
