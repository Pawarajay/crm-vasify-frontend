...
// // ============ frontend/components/projects/NotesDiscussion.jsx ============
// 'use client';
...
//                                     {note.created_by_name ? note.created_by_name.charAt(0).toUpperCase() : '?'}
//                                 </div>
//                                 <div>
...
//                                 </div>
//                             </div>
//                             <span className={`px-3 py-1 rounded-full text-xs font-medium ${getNoteTypeColor(note.note_type)}`}>
//                                 {note.note_type}
//                             </span>
//                         </div>
...
//                         <p className="text-gray-400 text-sm mt-1">Start the conversation above</p>
//                     </div>
//                 )}
//             </div>
//         </div>
