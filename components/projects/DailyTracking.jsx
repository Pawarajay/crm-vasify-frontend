...
// // ============ frontend/components/projects/DailyTracking.jsx ============
// 'use client';
// import { useState, useEffect } from 'react';
// import { Calendar, AlertCircle, CheckCircle, Clock } from 'lucide-react';

// export default function DailyTracking({ projectId }) {
...
//         try {
//             const response = await fetch(`/api/projects/${projectId}/daily-tracking`, {
...
//         switch(status) {
//             case 'Green': return <CheckCircle className="text-green-600" size={20} />;
//             case 'Yellow': return <AlertCircle className="text-yellow-600" size={20} />;
//             case 'Red': return <AlertCircle className="text-red-600" size={20} />;
...
//                                     onChange={(e) => setFormData({...formData, on_track_status: e.target.value})}
//                                     className="w-full px-4 py-2 border rounded-lg"
//                                 >
...
//                                 onChange={(e) => setFormData({...formData, actual_work: e.target.value})}
//                                 rows={3}
//                                 className="w-full px-4 py-2 border rounded-lg"
...
//                                 onChange={(e) => setFormData({...formData, issues_logged: e.target.value})}
//                                 rows={2}
//                                 className="w-full px-4 py-2 border rounded-lg"
...
//                         <div>
//                             <label className="block text-sm font-medium mb-2">Tomorrow's Plan</label>
//                             <textarea
...
//                                         })}
//                                     </h4>
//                                     <p className="text-sm text-gray-600">Logged by {entry.logged_by_name}</p>
//                                 </div>
//                             </div>
//                             <span className={`px-3 py-1 rounded-full text-xs font-medium ${getStatusColor(entry.on_track_status)}`}>
...
//                         <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//                             <div>
//                                 <h5 className="font-semibold text-sm text-gray-700 mb-2">Planned Work</h5>
//                                 <p className="text-gray-600 text-sm whitespace-pre-wrap">{entry.planned_work || 'N/A'}</p>
//                             </div>
//                             <div>
//                                 <h5 className="font-semibold text-sm text-gray-700 mb-2">Actual Work</h5>
//                                 <p className="text-gray-600 text-sm whitespace-pre-wrap">{entry.actual_work || 'N/A'}</p>
//                             </div>
//                         </div>

//                         {entry.issues_logged && (
//                             <div className="mt-4 p-3 bg-red-50 rounded-lg">
//                                 <h5 className="font-semibold text-sm text-red-800 mb-1">Issues/Blockers</h5>
//                                 <p className="text-red-700 text-sm whitespace-pre-wrap">{entry.issues_logged}</p>
//                             </div>
//                         )}

//                         {entry.tomorrow_plan && (
//                             <div className="mt-4 p-3 bg-blue-50 rounded-lg">
//                                 <h5 className="font-semibold text-sm text-blue-800 mb-1">Tomorrow's Plan</h5>
//                                 <p className="text-blue-700 text-sm whitespace-pre-wrap">{entry.tomorrow_plan}</p>
//                             </div>
//                         )}
//                     </div>
//                 ))}
...
//                         <p className="text-gray-500">No daily tracking entries yet</p>
//                         <p className="text-gray-400 text-sm mt-1">Click "Add Entry" to start tracking daily progress</p>
//                     </div>
//                 )}
//             </div>
//         </div>
...
//       if (e.tracking_date) {
//         const key = e.tracking_date.split('T')[0] || e.tracking_date;
//         map[key] = e;
//       }
//     }
//     return map;
...
//                   No daily update recorded for this day. Click &quot;Add&quot; to log
