// // frontend/app/projects/[id]/page.jsx
// 'use client';
...
//                                         {project.status}
//                                     </span>
//                                     <div className={`w-3 h-3 rounded-full ${getHealthColor(project.health_rating)}`} 
//                                          title={`Health: ${project.health_rating}`}></div>
//                                 </div>
...
//                             <span className="font-semibold text-gray-900">{project.progress_percentage || 0}%</span>
//                         </div>
...
//                 {activeTab === 'overview' && <ProjectOverview project={project} onUpdate={fetchProjectDetails} />}
//                 {activeTab === 'team' && <TeamAllocation project={project} onUpdate={fetchProjectDetails} />}
//                 {activeTab === 'daily' && <DailyTracking projectId={project.id} />}
...
//                   </span>
//                   <div
//                     className={`w-3 h-3 rounded-full ${getHealthColor(project.health_rating)}`}
...
//testing for edit & export button
// ============ app/projects/[id]/page.jsx (ProjectDetailPage) ============
'use client';
